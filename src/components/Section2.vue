<template>
  <div
    class="px-10 md:px-32 skillssection"
    id="section"
    data-aos="fade-left"
    data-aos-delay="20"
...
<style>
@import url("https://fonts.googleapis.com/css2?family=Press+Start+2P&family=Allison&family=Nunito+Sans:ital,wght@0,200;0,300;0,400;0,600;0,700;0,800;0,900;1,200;1,300;1,400;1,600;1,700;1,800;1,900&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800&family=Sedgwick+Ave&display=swap");
.icons {
  width: 10%;
  display: flex;
