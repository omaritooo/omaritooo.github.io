  ...
  <header class="diver">
    <div class="flex flex-col items-center pt-40 pb-20 text-center">
      <a
        ...
        class="z-0 text-4xl text-purple-500 uppercase md:text-6xl int"
      ...
      <a
        ...
        data-aos-duration="1000"
        data-aos-easing="ease-in-out"
        class="mt-4 text-2xl italic text-gray-400 md:text-4xl frnt"
      ...
      <svg
        ...
        data-aos-duration="1000"
        data-aos-easing="ease-in-out"
        class="z-0 w-1/2 mt-10 md:w-full md:mt-20"
        width="354px"
        height="280px"
        viewBox="0 0 264 280"
        version="1.1"
